        ...
        <h2 className="text-white">Rana</h2>
          ...
          <ul className="navbar-nav ">
            <li className="nav-item ">
              <Link className="nav-link link-nav" to="main-header" spy={true} smooth={true} offset={50} duration={500} >Home</Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link link-nav" to="skills" spy={true} smooth={true} offset={50} duration={500} >Skills</Link>
            </li>

            <li className="nav-item">
              <Link className="nav-link link-nav" to="projects" spy={true} smooth={true} offset={50} duration={500} >Projects </Link>
            </li>
